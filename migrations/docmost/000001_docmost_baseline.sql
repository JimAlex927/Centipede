-- Fresh databases only. Generated from Docmost migrations through 20260825T022612-oauth.
-- PostgreSQL 17+. Contains schema only, no users, credentials or application data.
-- Do not apply to an existing Docmost database.
--
...
--
-- Name: oauth_grants oauth_grants_user_client_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.oauth_grants
    ADD CONSTRAINT oauth_grants_user_client_unique UNIQUE (user_id, client_id);
...
--
-- Name: attachments_file_name_trgm_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX attachments_file_name_trgm_idx ON public.attachments USING gin (lower(translate((file_name)::text, '_.-'::text, '   '::text)) public.gin_trgm_ops);
...
--
-- Name: oauth_authorization_codes_consumed_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX oauth_authorization_codes_consumed_at_idx ON public.oauth_authorization_codes USING btree (consumed_at);
...
--
-- Name: oauth_authorization_codes_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: oauth_authorization_codes_workspace_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: oauth_clients_workspace_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX oauth_clients_workspace_id_idx ON public.oauth_clients USING btree (workspace_id);


--
-- Name: oauth_grants_client_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX oauth_grants_client_id_idx ON public.oauth_grants USING btree (client_id);


--
-- Name: oauth_tokens_access_expires_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX oauth_tokens_access_expires_at_idx ON public.oauth_tokens USING btree (access_expires_at);


--
-- Name: oauth_tokens_access_token_jti_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX oauth_tokens_access_token_jti_idx ON public.oauth_tokens USING btree (workspace_id, access_token_jti);


--
-- Name: oauth_tokens_grant_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX oauth_tokens_grant_id_idx ON public.oauth_tokens USING btree (grant_id);


--
-- Name: oauth_tokens_refresh_expires_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX oauth_tokens_refresh_expires_at_idx ON public.oauth_tokens USING btree (refresh_expires_at);


--
-- Name: oauth_tokens_revoked_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX oauth_tokens_revoked_at_idx ON public.oauth_tokens USING btree (revoked_at);
...
--
-- Name: pages_title_trgm_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_title_trgm_idx ON public.pages USING gin (lower((title)::text) public.gin_trgm_ops);
...
--
-- Name: oauth_clients oauth_clients_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.oauth_clients
    ADD CONSTRAINT oauth_clients_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.oauth_grants
    ADD CONSTRAINT oauth_grants_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.oauth_clients(id) ON DELETE CASCADE;
...
--
-- Name: oauth_grants oauth_grants_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.oauth_grants
    ADD CONSTRAINT oauth_grants_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;


--
-- Name: oauth_tokens oauth_tokens_grant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.oauth_tokens
    ADD CONSTRAINT oauth_tokens_grant_id_fkey FOREIGN KEY (grant_id) REFERENCES public.oauth_grants(id) ON DELETE CASCADE;


--
-- Name: oauth_tokens oauth_tokens_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.oauth_tokens
    ADD CONSTRAINT oauth_tokens_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;
