...
func (handler *Handler) registerExtraRoutes(router gin.IRouter) {
	...
	router.POST("/ai/chats", handler.aiChats)
	router.POST("/ai/chats/create", handler.createAIChat)
	router.POST("/ai/chats/info", handler.aiChatInfo)
	router.POST("/ai/chats/delete", handler.deleteAIChat)
	router.POST("/ai/chats/update", handler.updateAIChat)
	router.POST("/ai/chats/search", handler.searchAIChats)
	router.POST("/ai/chats/upload", handler.uploadAIChatFile)
	router.POST("/ai/chats/send", handler.sendAIChatMessage)
	router.POST("/ai/generate", handler.aiGenerate)
	router.POST("/ai/generate/stream", handler.aiGenerateStream)
	router.POST("/ai/answers", handler.aiAnswers)
	router.POST("/ai/vector-cache-hint", handler.vectorCacheHint)
	router.POST("/bases", handler.bases)
	router.POST("/bases/pages/expand", handler.expandBasePages)
	router.POST("/bases/info", handler.baseInfo)
	router.POST("/bases/create", handler.createBase)
	router.POST("/bases/update", handler.updateBase)
	router.POST("/bases/delete", handler.deleteBase)
	router.POST("/bases/convert", handler.convertPageToBase)
	router.POST("/bases/export-csv", handler.exportBaseCSV)
	router.POST("/bases/properties/create", handler.basePropertiesCreate)
	router.POST("/bases/properties/update", handler.basePropertiesUpdate)
	router.POST("/bases/properties/delete", handler.basePropertiesDelete)
	router.POST("/bases/properties/reorder", handler.basePropertiesReorder)
	router.POST("/bases/rows", handler.baseRows)
	router.POST("/bases/rows/info", handler.baseRowInfo)
	router.POST("/bases/rows/create", handler.baseRowsCreate)
	router.POST("/bases/rows/update", handler.baseRowsUpdate)
	router.POST("/bases/rows/delete", handler.baseRowsDelete)
	router.POST("/bases/rows/delete-many", handler.baseRowsDeleteMany)
	router.POST("/bases/rows/reorder", handler.baseRowsReorder)
	router.POST("/bases/views", handler.baseViews)
	router.POST("/bases/views/create", handler.baseViewsCreate)
	router.POST("/bases/views/update", handler.baseViewsUpdate)
	router.POST("/bases/views/delete", handler.baseViewsDelete)
	router.POST("/personal-space/info", handler.personalSpaceInfo)
	router.POST("/personal-space/create", handler.createPersonalSpace)
	router.POST("/scim-tokens", handler.scimTokens)
	router.POST("/scim-tokens/create", handler.createSCIMToken)
	router.POST("/scim-tokens/update", handler.updateSCIMToken)
	router.POST("/scim-tokens/revoke", handler.revokeSCIMToken)
	router.POST("/sso/providers", handler.ssoProviders)
	router.POST("/sso/info", handler.ssoInfo)
	router.POST("/sso/create", handler.createSSOProvider)
	router.POST("/sso/update", handler.updateSSOProvider)
	router.POST("/sso/delete", handler.deleteSSOProvider)
	...
	router.POST("/audit", handler.auditLogs)
	router.POST("/audit/retention", handler.auditRetention)
	router.POST("/audit/retention/update", handler.updateAuditRetention)
